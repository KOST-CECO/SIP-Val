...
public class UpdateProxyConfigDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        proxyTypeComboBox.setModel(new DefaultComboBoxModel(new String[] { "HTTP", "SOCKS" }));

        binding = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, this, ELProperty.create("${properties[\"update.proxy.type\"]}"), proxyTypeComboBox, BeanProperty.create("selectedItem"));
        bindingGroup.addBinding(binding);


        jLabel7.setText(NbBundle.getMessage(UpdateProxyConfigDialog.class, "UpdateProxyConfigDialog.jLabel7.text")); // NOI18N
        ...
        proxySettingsPanelLayout.setHorizontalGroup(
            ...
            .addGroup(Alignment.TRAILING, proxySettingsPanelLayout.createSequentialGroup()
                .addContainerGap()
                ...
                .addGroup(proxySettingsPanelLayout.createParallelGroup(Alignment.LEADING)
                    .addComponent(proxyTypeComboBox, GroupLayout.PREFERRED_SIZE, 74, GroupLayout.PREFERRED_SIZE)
                    .addGroup(proxySettingsPanelLayout.createSequentialGroup()
                        .addComponent(proxyHostTextBox, GroupLayout.DEFAULT_SIZE, 168, Short.MAX_VALUE)
                        .addGap(26, 26, 26)
        ...
        proxySettingsPanelLayout.setVerticalGroup(
            ...
            .addGroup(proxySettingsPanelLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(proxySettingsPanelLayout.createParallelGroup(Alignment.BASELINE)
                    .addComponent(proxyTypeComboBox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel7))
