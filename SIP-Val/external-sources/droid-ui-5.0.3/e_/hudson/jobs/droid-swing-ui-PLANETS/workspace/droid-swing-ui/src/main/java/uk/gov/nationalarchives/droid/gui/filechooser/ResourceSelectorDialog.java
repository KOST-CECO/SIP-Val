...
public class ResourceSelectorDialog extends JDialog {
    ...
    /**
     * 
     * @return true if selecet subfolders was checked; false otherwise
     */
            ...
            if (children != null) {
                ...
                for (File child : sortedChildren) {
                    ...
                    if (child.isDirectory()) {
                        ...
                        DefaultMutableTreeNode n = new DefaultMutableTreeNode(child, allowsChildren);
                        newChild.add(n);
                    }
                }
            }
    ...
    private class FileTreeCellRenderer extends DefaultTreeCellRenderer {
        ...
        public Component getTreeCellRendererComponent(JTree parentTree, Object value, 
            ...
            Component c = super.getTreeCellRendererComponent(parentTree, value, sel, expanded, leaf, row, hasFocus);
