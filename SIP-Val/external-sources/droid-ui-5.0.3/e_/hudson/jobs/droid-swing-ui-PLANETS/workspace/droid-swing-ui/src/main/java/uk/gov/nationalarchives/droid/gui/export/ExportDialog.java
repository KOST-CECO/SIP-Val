...
public class ExportDialog extends JDialog {
     ...
     */
    public ExportDialog(Frame parent, ExportAction action) {
        super(parent);
        this.action = action;
        initComponents();
        pack();
    ...
    private void initComponents() {
        ...
        setTitle(NbBundle.getMessage(ExportDialog.class, "ExportDialog.title")); // NOI18N
        setModal(true);
        setResizable(false);
        ...
        jLabel1.setText(NbBundle.getMessage(ExportDialog.class, "ExportDialog.jLabel1.text")); // NOI18N
