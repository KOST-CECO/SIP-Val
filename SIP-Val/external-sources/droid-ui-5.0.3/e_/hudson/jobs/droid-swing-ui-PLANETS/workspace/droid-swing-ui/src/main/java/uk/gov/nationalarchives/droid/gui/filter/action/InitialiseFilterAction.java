...
import uk.gov.nationalarchives.droid.gui.filter.domain.IdentificationStatusMetadata;
...
public class InitialiseFilterAction {
    ...
    public void initialiseFilter(String profileId,
        ...
        IdentificationStatusMetadata identificationStatusMetadata = new IdentificationStatusMetadata();
        ...
        filterDomain.addFilterCondition(identificationStatusMetadata);
        // filterDomain.addFilterCondition(indentificationConfidanceMetadata);
    }
