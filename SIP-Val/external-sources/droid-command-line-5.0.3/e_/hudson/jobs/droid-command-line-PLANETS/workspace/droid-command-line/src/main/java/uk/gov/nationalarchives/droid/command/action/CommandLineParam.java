...
public enum CommandLineParam {
    ...
    /** Export. */
    EXPORT("e", "export", false, 1, I18N.EXPORT_HELP, filename()) {
        @Override
        public DroidCommand getCommand(CommandFactory commandFactory, CommandLine cli) 
            throws CommandLineSyntaxException {
            return commandFactory.getExportCommand(cli);
        }
    }, 
    ...
    /** Disaply the default signature update. */
    ...
    static {
        ...
        addTopLevelCommand(CommandLineParam.LIST_SIGNATURE_VERSIONS);
    }
