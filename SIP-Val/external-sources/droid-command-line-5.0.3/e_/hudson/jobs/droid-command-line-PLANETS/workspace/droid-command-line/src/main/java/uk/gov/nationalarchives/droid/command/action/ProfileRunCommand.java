...
public class ProfileRunCommand implements DroidCommand {
    ...
    public void execute() throws CommandExecutionException {
        try {
            SignatureFileInfo sig = signatureManager.getDefaultSignature();
            ProfileInstance profile = profileManager.createProfile(sig);
            ...
            Future<Void> future = profileManager.start(profile.getUuid());
            future.get();
