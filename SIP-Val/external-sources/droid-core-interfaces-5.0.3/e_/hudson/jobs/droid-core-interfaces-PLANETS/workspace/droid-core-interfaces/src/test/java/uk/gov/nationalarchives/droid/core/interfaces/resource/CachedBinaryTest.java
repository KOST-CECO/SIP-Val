...
public class CachedBinaryTest {
    ...
    public void testGetInputStreamWithNoBackingFileCache() throws Exception {
        ...
        cache = new CachedBinary(1, 1000, blockZero);
        assertEquals(rawBytes[799], cache.getByte(799));
    ...
    public void testGetInputStreamWithBackingFileCache() throws Exception {
        ...
        tempDir.mkdir();
        cache.setRaf(new RandomAccessFile(ArchiveFileUtils.writeEntryToTemp(tempDir, blockZero, ch), "r"));
        
        assertEquals(rawBytes[8499], cache.getByte(8499));
