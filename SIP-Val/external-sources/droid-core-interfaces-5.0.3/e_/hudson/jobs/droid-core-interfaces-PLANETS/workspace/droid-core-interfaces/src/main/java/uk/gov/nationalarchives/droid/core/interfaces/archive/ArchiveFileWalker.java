...
public abstract class ArchiveFileWalker<T> {
     ...
     * @throws IOException if the the archive sopurce could not be read
     */
    ...
    private void walkInternal(Iterable<T> zipFile) throws IOException {
        for (T entry : zipFile) {
    ...
    /**
     * Dertmines if the walk has been cancelled.
