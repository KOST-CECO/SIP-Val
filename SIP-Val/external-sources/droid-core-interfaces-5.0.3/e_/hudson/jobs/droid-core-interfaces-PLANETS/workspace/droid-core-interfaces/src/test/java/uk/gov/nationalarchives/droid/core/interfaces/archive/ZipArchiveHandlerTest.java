...
public class ZipArchiveHandlerTest {
    ...
    public void testHandleZipFile() throws Exception {
        ...
        when(resultHandler.handleDirectory(any(IdentificationResult.class), eq(20L), eq(false))).thenReturn(20L);
        ...
        verify(resultHandler).handleDirectory(argThat(resultMatcher(expectedDirectories.get(0))), eq(20L), eq(false));
        verify(resultHandler).handleDirectory(argThat(resultMatcher(expectedDirectories.get(1))), eq(20L), eq(false));
    }
