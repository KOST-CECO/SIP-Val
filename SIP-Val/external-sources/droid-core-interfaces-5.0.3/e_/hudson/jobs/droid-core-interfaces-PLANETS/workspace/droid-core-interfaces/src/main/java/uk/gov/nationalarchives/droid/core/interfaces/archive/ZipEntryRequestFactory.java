...
public class ZipEntryRequestFactory extends AbstractArchiveRequestFactory {
     ...
     */
    @Override
    public ZipEntryIdentificationRequest newRequest(RequestMetaData metaData, RequestIdentifier identifier) {
        
        ZipEntryIdentificationRequest request = new ZipEntryIdentificationRequest(
