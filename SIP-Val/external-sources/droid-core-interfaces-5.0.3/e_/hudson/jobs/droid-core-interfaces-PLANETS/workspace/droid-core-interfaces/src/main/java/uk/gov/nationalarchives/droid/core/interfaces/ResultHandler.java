...
public interface ResultHandler {
     ...
     */
    long handle(IdentificationResultCollection result);
     ...
     * @return the alloacted ID of the handled result.
     */
    long handleDirectory(IdentificationResult result, Long parentId, boolean restricted);
    ...
    /**
     * @param nodeId the node Id to add a warning to
     */
    void addProblem(Long nodeId);
