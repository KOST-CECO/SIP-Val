...
public class JpaProfileFilterTest {
    ...
    public void testFilterOnPuid() {
        ...
        assertNotNull(nodes.get(0).getFormatIdentifications().get(0).getFormat());
        assertEquals("NONE", nodes.get(0).getFormatIdentifications().get(0).getFormat().getPuid());

        nodes = profileDao.findProfileResourceNodes(null, filter);
        ...
        assertNotNull(nodes.get(0).getFormatIdentifications().get(0));
        assertNotNull(nodes.get(0).getFormatIdentifications().get(0).getFormat());
        assertEquals("fmt/alok", nodes.get(0).getFormatIdentifications().get(0).getFormat().getPuid());

        assertNotNull(nodes.get(1).getFormatIdentifications().get(0));
        assertNotNull(nodes.get(1).getFormatIdentifications().get(0).getFormat());
        assertEquals("fmt/alok", nodes.get(1).getFormatIdentifications().get(0).getFormat().getPuid());
    }
