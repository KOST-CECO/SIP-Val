    ...
    public Object getValue() {
        ...
        if (selectedValues != null && !selectedValues.isEmpty()) {
            ...
            for (FilterValue v : selectedValues) {
                value[i++] = FilterValueTypeConverter.convert(fieldName, v.getQueryParameter());
            }
            obj = value;
        } else if (valueFreeText != null) {
            obj = FilterValueTypeConverter.convert(fieldName, valueFreeText);
        }
        return obj;
    }
    
    private static final class FilterValueTypeConverter {
        
        private FilterValueTypeConverter() { }
        
        // CHECKSTYLE:OFF FIXME: better ways than this...
        static Object convert(CriterionFieldEnum fieldType, String s) {
            // CHECKSTYLE:ON
            Object o;
            switch (fieldType) {
                case FILE_EXTENSION:
