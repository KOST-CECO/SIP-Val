...
public class SubmissionGatewayTest {
    ...
    public void testDroid4IndentificationWithAZipFile() throws Exception {
        ...
        Droid4LegacyDroid droid = new Droid4LegacyDroid();
        ...
        when(archiveFormatResolver.forPuid("x-fmt/412")).thenReturn(ArchiveFormat.ZIP);

        ZipArchiveHandler zipHandler = new ZipArchiveHandler();
        ...
        when(archiveHandlerFactory.getHandler(ArchiveFormat.ZIP)).thenReturn(zipHandler);
    ...
    public void testResultAvailableWhenIdentificationFailed() throws InterruptedException {
        ...
        when(request.getFileName()).thenThrow(new RuntimeException("I failed"));
